...
(function () {
    ...
    var C = function (a, b, c) {
        ...
        ta = /[\ud800-\udbff][\udc00-\udfff]|[^!-~]/g,
        ua = new RegExp(/(%([^0-9a-fA-F%]|[0-9a-fA-F]([^0-9a-fA-F%])?)?)*/.source + /%($|[^0-9a-fA-F]|[0-9a-fA-F]($|[^0-9a-fA-F]))/.source,
            "g"),
    ...
    var Ea = function (a, b, c, d) {
            if (q[c + "EventListener"]) q[c + "EventListener"](a, b, !1);
    ...
    var kb = decodeURI("%73cript"),
        ...
        nb = function () {
            var a = F.nonce;
            return void 0 !== a ? a && a === String(a) && a.match(lb) ? a : F.nonce = null : t.querySelector ? (a = t.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(lb) ? F.nonce = a : F.nonce = null) : null : null
        },
        pb = function (a) {
            if ("loading" != t.readyState) ob(a);
            else {
                var b = nb(),
                    c = "";
                null !== b && (c = ' nonce="' +
                    b + '"');
                t.write("<" + kb + ' src="' + encodeURI(a) + '"' + c + "></" + kb + ">")
            }
        },
        ob = function (a) {
            var b = t.createElement(kb);
        ...
        tb = function (a, b,
            ...
            if (y.length) {
                ...
                if (y.length) {
                    ...
                    h.push.apply(h, y);
                    Va("ml0", y, r);
                    b.sync || q.___gapisync ? pb(a) : ob(a)
                } else E[I](fa)
            } else u(y) && d && d()
        };
    var rb = function (a, b) {
        if (F.hee && 0 < F.hel) try {
            ...
            b && b(c), F.hel--, K("debug_error", function () {
                try {
    ...
    var L = function (a) {
        ...
        xb = function (a) {
            ...
            d = L("cd");
            a = 0;
            for (b = d.length; a < b; ++a) N(M(), d[a], !0);
            d = L("ci");
            a = 0;
            for (b = d.length; a < b; ++a) N(M(), d[a], !0);
            a = 0;
            for (b = c.length; a < b; ++a) N(M(), c[a], !0)
        },
        O = function (a) {
            var b = M();
            if (!a) return b;
        ...
        Db = function () {
            if (!Bb) {
                ...
                if (window.self !== window.top) {
                    ...
                    for (var e in Ab) 0 < Ab[e] && (b = C(a, e, "")) && (Cb[e] = b)
                }
                Bb = !0
            }
            e = w();
    ...
    var Lb;
    var Mb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
        Nb = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/b\/(\d{10,21})\//,
        Ob = function (a) {
            ...
            null == b && (a = a || window.location.href, b = C(a, "authuser") ||
                null, null == b && (b = (b = a.match(Mb)) ? b[1] : null));
        ...
        Pb = function (a) {
            ...
            null == b && (b = (a = (a || window.location.href).match(Nb)) ? a[1] : null);
            if (null == b) return null;
            b = String(b);
            21 < b.length && (b = null);
            return b
    ...
    var Qb, Q, R = void 0,
        ...
        U = function (a, b) {
            ...
            if ("undefined" !== d) {
                ...
                if (null == a) b[b.length] = "null";
                    ...
                    if (e === Sb) return U(a.toISOString.call(a), c);
                    if (e === Wb && T(a.length) === Rb) {
                        b[b.length] = "[";
                        var f = 0;
        ...
        Xb = /[\0-\x07\x0b\x0e-\x1f]/,
        Yb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/,
        Zb = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/,
        $b = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/,
        ...
        nc = function (a) {
            a = String(a);
            if (Xb.test(a) || Yb.test(a) || Zb.test(a) || $b.test(a)) return !1;
            var b = a.replace(ac, '""');
            b = b.replace(bc, "0");
            b = b.replace(cc, "");
        ...
        qc = function (a) {
            if (-1 !== Q) return oc(), R ? m.JSON.stringify.call(m.JSON, a) : U(a)
        },
    ...
    var wc = q.crypto,
        ...
        Dc = function (a) {
            ...
            Ac = Ac * b % Bc;
            0 < yc && ++zc == yc && Ea("mousemove", Dc, "remove", "de")
        },
        Ec = function (a) {
            var b = new vc;
    ...
    xc || (Bc = 1E6 * (screen.width * screen.width + screen.height), Cc = Ec(t.cookie + "|" + t.location + "|" + (new Date).getTime() + "|" + Math.random()), yc = O("random/maxObserveMousemove") || 0, 0 != yc && Ea("mousemove", Dc, "add", "at"));
    var Fc = function () {
            var a = Ac;
            a += parseInt(Cc.substr(0, 20), 16);
            Cc = Ec(Cc);
            return a / (Bc + Math.pow(16, 20))
        },
        Gc = function () {
            var a = new q.Uint32Array(1);
    ...
    var Hc = function () {
        ...
        Ic = function (a, b) {
            b = b.onload;
            return "function" === typeof b ? (Hc().a(a, b), b) : null
        },
        Jc = function (a) {
    ...
    var Vc = function (a) {
        ...
        Wc = function (a) {
            ...
            for (var b = document.getElementsByTagName("link"), c = 0, d = b.length; c < d; c++) {
                ...
                if (f && f.toLowerCase() == a && (e = e.getAttribute("href")) && (e = Vc(e)) && null != e.match(/^https?:\/\/[\w\-_\.]+/i)) return e
            }
    ...
    var Xc = {
        ...
        $c = "onPlusOne _ready _close _open _resizeMe _renderstart oncircled drefresh erefresh".split(" "),
        ad = v(F, "WI", w()),
        bd = function (a, b, c) {
            var d;
            var e = {};
            ...
            for (var g in Xc) e[g] = g + "/" + (b[g] || Xc[g]) + "/";
            e = Ca(t, d.replace(Rc,
                Uc(e)));
            g = "iframes/" + a + "/params/";
            f = {};
            ...
            Yc[a] || (f.origin = window.location.origin || window.location.protocol + "//" + window.location.host);
            f.exp = O(g + "exp");
            if (g = O(g + "location"))
            ...
            switch (a) {
                ...
                case "follow":
                    ...
                    g = (g = "string" == typeof g ? g : void 0) ? Vc(g) : Wc(d);
                    f.url = g;
                    delete f.href;
                    break;
                case "plusone":
            ...
            delete f.rd;
            for (var k in Xc) f[k] && delete f[k];
            ...
            l = "q" == O("iframes/" + a + "/params/si") ? f :
                c;
            k = Db();
            for (var p in k) !x(k, p) || x(f, p) || x(c, p) || (l[p] = k[p]);
            p = [].concat($c);
            (l = O("iframes/" + a + "/methods")) && "object" === typeof l && ha.test(l.push) && (p = p.concat(l));
            for (var n in b) x(b, n) && /^on/.test(n) && ("plus" != a || "onconnect" != n) && (p.push(n), delete f[n]);
            delete f.callback;
            c._methods = p.join(",");
            return za(e, f, c)
        },
        cd = ["style", "data-gapiscan"],
        ed = function (a) {
            ...
            a = a.style;
            (c = dd(a && a.height)) && (b.height = String(c));
            (a = dd(a && a.width)) && (b.width = String(a));
            return b
        },
        dd = function (a) {
            var b = void 0;
    ...
    var nd = function (a, b) {
        ...
        md = function (a, b, c, d) {
            ...
            if (c.querySelectorAll && (!e || 8 < e)) {
                e = d ? [d] : qa(W).concat(qa(hd)).concat(qa(X));
            ...
            for (f = 0; f < e.length; f++) {
                ...
                if (k.getAttribute("data-gapiscan")) h = null;
                    ...
                    var n =
                        l.indexOf("g:");
                    0 == n ? p = l.substr(2) : (n = (n = String(k.className || k.getAttribute("class"))) && kd.exec(n)) && (p = n[1]);
                    h = !p || !(W[p] || hd[p] || X[p]) || h && p !== h ? null : p
                }
                h && (ld[h] || 0 == g.nodeName.toLowerCase().indexOf("g:") || 0 != qa(ed(g)).length) && (g.setAttribute("data-gapiscan", !0), v(c, h, []).push(g))
            }
            if (b)
                for (var r in c)
    ...
    var pd = function (a, b) {
            ...
            switch (wd(b, a, f)) {
                ...
                case 1:
                    if (b.parentNode) {
                        ...
                        g.siteElement =
                            k;
                        k.id || (b = k, v(ad, a, 0), f = "___" + a + "_" + ad[a]++, b.id = f);
                        b = w();
                        b[">type"] = a;
                        z(c, b);
                        f = h;
                        ...
                        e = b = f;
                        Qc.test(b) && (e = O("iframes/" + e.substring(1) + "/url"), A(!!e, "Unknown iframe url config for - " + b));
                        f = Ca(t, e.replace(Rc, Tc));
                        b = c.ownerDocument || t;
                        k = 0;
                        do e = h.id || ["I", Nc++, "_", (new Date).getTime()].join(""); while (b.getElementById(e) && 5 > ++k);
                        ...
                        var p = h.pfname;
                        var n = w();
                        O("iframes/dropLegacyIdParam") || (n.id = e);
                        n._gfid = e;
                        n.parent = b.location.protocol + "//" + b.location.host;
                        var r = C(b.location.href, "parent");
                        p = p || "";
                        !p && r && (r = C(b.location.href, "_gfid", "") || C(b.location.href, "id", ""), p = C(b.location.href, "pfname", ""), p = r ? p + "/" + r : "");
                        p || (r = pc(C(b.location.href, "jcp", ""))) && "object" == typeof r && (p = (p = r.id) ? r.pfname + "/" + p : "");
                        n.pfname =
                            p;
                        h.connectWithJsonParam && (r = {}, r.jcp = qc(n), n = r);
                        r = C(f, "rpctoken") || k.rpctoken || l.rpctoken;
                        r || (r = h.rpctoken || String(Math.round(1E8 * (xc ? Gc() : Fc()))), n.rpctoken = r);
                        h.rpctoken = r;
                        z(n, h.connectWithQueryParams ? k : l);
                        r = b.location.href;
                        n = w();
                        (p = C(r, "_bsh", F.bsh)) && (n._bsh = p);
                        (r = La(r)) && (n.jsh = r);
        ...
        fd = function (a, b) {
            ...
            if (d) {
                ...
                rd(c, e)
            } else Gb("string" === "gapi." + c + ".render: missing element " + typeof a ? a : "")
        };
    v(B, "platform", {}).go = nd;
    od = function (a) {
    ...
    H.push(["platform", function (a, b, c) {
        ...
        if ("explicit" != O("parsetags")) {
            Ma(a);
            Eb(Db()) && !O("disableRealtimeCallback") && Ib();
            if (c && (a = c.callback)) {
                var d = ra(a);
                delete c.callback
            }
    ...
    Ib = function () {
        F.oa = !0;
        var a = Qd();
        (a = a && a.D) && yb("googleapis.config/sessionIndex", a);
        Td || (Td = v(F, "ss", new Z));
        a = Td;
        a.U && a.U()
    };
            ...
            callback: function () {
                ...
                a.checkSessionState(e, function (b) {
                    var c = e.session_state,
                        d = O("isLoggedIn");
                    b = O("debug/forceIm") ? !1 : c && b || !c && !b;
                    if (d = d != b) yb("isLoggedIn", b), Ib(), gd(), b || ((b = a.signOut) ? b() : (b = a.setToken) && b(null));
                    b = Db();
                    var f = O("savedUserState");
                    c = a._guss(b.cookiepolicy);
                    f = f != c && "undefined" != typeof f;
                    yb("savedUserState", c);
                    (d || f) && Eb(b) && !O("disableRealtimeCallback") && a._pimf(b, !0)
                })
            }
        });
        return !0
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.ko.mxilO3VBKgY.O/am\u003dQQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCMTp5hsz0XcKvy90zNXIYnjMM4g1Q/m\u003d__features__",
